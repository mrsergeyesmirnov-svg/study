...
| **Start Command** | **ПУСТО** |
| Variables | DATABASE_URL, BOT_TOKEN, ADMIN_TELEGRAM_IDS, CHANNEL_MAIN_ID=@baobab6714, CHANNEL_STOCK_ID (опц.), CHANNEL_IMPORT_ID (опц., по умолчанию = MAIN), PUBLIC_URL=https://web-домен, WEBAPP_URL=https://web-домен, **API_PUBLIC_URL=https://study-домен** |
