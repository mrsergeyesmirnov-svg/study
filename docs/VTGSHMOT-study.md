...
| Купили в шоуруме | «Продано в магазине» | Продавец на месте |
...
## 3.3 Оплата переводом (текущая реальность)
...
**Результат:** вместо скринshотов — заказы; перевод на карту остаётся, но учёт централизован.
